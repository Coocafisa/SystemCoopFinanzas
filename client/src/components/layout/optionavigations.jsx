...
const routeToIndices = {
    ...
    "/home/user/entities/invoices": [5, 6],
    "/home/user/entities/invoices/payments": [4, 6],
    "/home/user/entities/invoices/pending": [4, 5],
...
const menuOptions = [
  ...
  { id: 3, label: "Gestion de Correos", link: "/home/administrator/email", icon: "bi bi-envelope-plus-fill" },
  ...
  { id: 7, label: "Correos Pendientes", link: "/home/administrator/emailPending", icon: "bi bi-envelope-slash-fill"},
